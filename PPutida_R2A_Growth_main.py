...
MP = pd.read_csv('/Users/shara/Desktop/Vnat_GrowthCurveAnalysis/PPutida_R2A_Expt1.csv')      # MP - Micro Plate
...
train_dict_key = keys_all[1:47:2]
test_dict_key = keys_all[2:47:4]
valid_dict_key = keys_all[4:47:4]
...
n_LinReg_vec = [14]#np.arange(8,15,2)#np.array(list(range(9,14,2))) # Number of Linear-Regressors - monomials of order 1
n_mon_vec = [3]    # Maximum order of the number of monomials
